<div class="@if($paginator->hasPages()) bg-gray-100 px-4 py-4 rounded-md @endif">
                            ...
                            @if ($paginator->onFirstPage())
                                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                                    <span class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default ltr:rounded-l-md rtl:rounded-r-md leading-5" aria-hidden="true">
                                        <svg class="w-5 h-5 rtl:hidden" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
                                        </svg>
                                        <svg class="w-5 h-5 ltr:hidden" fill="currentColor" viewBox="0 0 20 20">
