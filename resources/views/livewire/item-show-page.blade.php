<section class="container mx-auto py-16 py-10 font-poppins dark:bg-gray-800">
                                ...
                                <div class="p-2 rounded-xl lg:p-6 dark:bg-gray-800 bg-gray-50">
                                    <div class="flex flex-wrap justify-center gap-x-10 gap-y-4">
                                        ...
                                        <div class="w-full mb-4 lg:mb-0 md:w-2/5">
                                            <div class="flex ">
                                                <span class="mr-3 text-gray-500 dark:text-gray-400">
                                                <svg width="30" height="30" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="20" width="8" height="14" fill="none" stroke="#333" stroke-width="1" stroke-linejoin="round"/><rect x="20" y="14" width="8" height="26" fill="none" stroke="#333" stroke-width="1" stroke-linejoin="round"/><path d="M24 44V40" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/><rect x="34" y="12" width="8" height="9" fill="none" stroke="#333" stroke-width="1" stroke-linejoin="round"/><path d="M10 20V10" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/><path d="M38 34V21" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/><path d="M38 12V4" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                                </span>
                                                <div>
                                                    <p class="mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                                                        Availability
