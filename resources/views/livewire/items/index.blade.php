    ...
    <div class="container grid md:grid-cols-4 grid-cols-2 gap-6 pt-4 pb-16 items-start">
        ...
        <div id="drawer-example"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <a href="#"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-lime-700 rounded-lg hover:bg-lime-800 focus:ring-4 focus:ring-lime-300 dark:bg-lime-600 dark:hover:bg-lime-700 focus:outline-none dark:focus:ring-lime-800">
                    Get access
        ...
        <div class="col-span-3">
            <div class="flex items-center justify-between mb-0">
                ...
                <div class="text-center md:hidden">
                    <button
                        class="bg-lime-600 text-white hover:bg-lime-800 focus:ring-4 focus:ring-lime-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-lime-600 dark:hover:bg-lime-700 focus:outline-none dark:focus:ring-lime-800 block md:hidden"
            ...
            <div class="grid md:grid-cols-3 grid-cols-2 gap-6">
                @foreach ($items as $item)
                    <livewire:shared.item :item="$item" :key="$item->id" />
                @endforeach
            </div>
