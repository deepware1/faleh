                        ...
                        <ul class="py-2 font-medium" role="none">
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <div class="inline-flex items-center">
                                        <img class="h-3.5 w-3.5 rounded-full mr-2"
                                            src="{{ url('images/flags/deutsch.svg') }}">
                                        Deutsch
                                    </div>
                                </a>
                            </li>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                ...
                <ul
                    ...
                    <li>
                        <a href="{{ route('home') }}"
                            class="block py-2 pl-3 pr-4 text-white bg-lime-700 rounded md:bg-transparent md:text-lime-700 md:p-0 md:dark:text-lime-500"
                            aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="{{ route('categories') }}"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-lime-700 md:p-0 md:dark:hover:text-lime-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Categories</a>
                    </li>
                    <li>
                        <a href="{{ route('blogs') }}"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-lime-700 md:p-0 md:dark:hover:text-lime-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Blog</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-lime-700 md:p-0 md:dark:hover:text-lime-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    @foreach ($categories as $category)
                        <li>
                            <a href="{{ route('subcategories', $category->slug) }}"
                                class="text-gray-900 dark:text-white hover:underline">{{ $category->title }}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
